...
class OLED_1inch3(framebuf.FrameBuffer):
    ...
    def display_text(self, text, x=4,y=8):
        #x and y specify upper left corner of message
        self.text(text,x,y)
        
    def draw_horizontal_line(self,y, x=0, w=128):
        #x and specify where to start line and w is its width
        self.hline(x,y,w,self.white)
